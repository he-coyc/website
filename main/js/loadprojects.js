let projects = [
    {
        ...
        'link': 'https://he-coyc.ru/vkrandom',
        'category': 'tools',
    },
    {
        'name': 'KOHTPAKT bot',
    ...
    },
    {
        ...
        'link': 'https://he-coyc.ru/skufizator/',
        'category': 'useless',
    },
    {
        ...
        'link': 'https://he-coyc.ru/skufariktoday',
        'category': 'useless',
    },
    {
...
function loadProjects(string){
    ...
    <div class="project-back">
        ...
        <a title="Open project" class="project-view-button" target="_blank" href="${link}">
            view
        </a>
    </div>  
        `
